    ...
    >
      ...
      <section className="relative h-[80vh] bg-gradient-to-b from-amber-900 via-amber-700 to-amber-500 overflow-hidden">
        ...
        <motion.button
          ...
          className="absolute bottom-6 left-1/2 z-30 bg-amber-600/80 hover:bg-amber-600 backdrop-blur-md text-white rounded-full p-4 border-2 border-white/40 transition-all shadow-2xl flex items-center justify-center cursor-pointer"
        >
